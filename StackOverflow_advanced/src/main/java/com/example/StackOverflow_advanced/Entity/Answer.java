...
public class Answer {
    ...
    public Answer(String id, String questionId, String title, String text, Set<User> upvotedBy, Set<User> downvotedBy, int upvotes, int downvotes, User postedBy, LocalTime postedAt) {
        this.id = id;
